...
const SidebarComp = ({openProfile}) => {
  return (
    <aside className="fixed top-0 left-0 z-[100] flex flex-col w-full h-screen overflow-hidden hover:overflow-y-auto md:w-80  px-5 py-8  bg-gray-900  dark:bg-gray-900">

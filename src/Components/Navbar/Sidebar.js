...
import img from '../../../public/Resources/images/testimonial2.jpg';
import { LiaTimesSolid } from 'react-icons/lia';

const SidebarComp = ({openProfile}) => {
  return (
    <aside className="fixed top-0 left-0 z-[100] flex flex-col w-full h-screen hover:overflow-y-auto lg:overflow-hidden md:w-80  px-5 py-8  bg-gray-900  dark:bg-gray-900">
      <div className="flex flex-row justify-between">
        <div className="a flex flex-col gap-4 w-fit">
          ...
          <div className="name">
            <p className="text-base">Good afternoon 👋</p>
            <h2 className="text-white font-semibold text-lg">Nnnamdi Ibe</h2>
          </div>
        </div>
        <div className="b">
          <LiaTimesSolid className="text-3xl cursor-pointer" onClick={openProfile} />
        </div>
      </div>
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        ...
        <div className="mt-6">
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            <span className="text-md font-medium text-gray-100 dark:text-gray-200">
                Sign Out
              </span>

            <a
              href="#"
              className="text-gray-200 transition-colors duration-200 rotate-180 dark:text-gray-400 rtl:rotate-0 hover:text-blue-500 dark:hover:text-blue-400"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
